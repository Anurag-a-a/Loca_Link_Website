...
CREATE TABLE `comment`  (
  ...
  `createTime` timestamp NULL DEFAULT CURRENTuseruser_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (0000000001, 'AnuragAT', 'Password123@', 'anurag@mail.com', 0, NULL, NULL);
